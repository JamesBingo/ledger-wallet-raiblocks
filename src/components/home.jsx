...
const logMsg    = require('./util').logMsg;

const BASE58    = '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz';
const base58    = require('base-x')(BASE58);

logMsg( "STARTED comm_node \n" );
logMsg( JSON.stringify(comm_node) + "\n" );
logMsg( comm_node + "\n" );
logMsg( Object.getOwnPropertyNames(comm_node) + "\n" );
logMsg( "SUCCESS comm_node \n" );
